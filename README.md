...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/solana-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13591&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/solana-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `solana` can be installed with:

```
conda install solana
```

It is possible to list all of the versions of `solana` available on your platform with:
